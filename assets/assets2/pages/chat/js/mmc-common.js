...
//             '<div class="body media-body text-right"><div class="content msg-reply f-12 bg-success d-inline-block sms_content">'+ text +'</div><div class="seen"><i class="icon-clock f-12 m-r-5 txt-muted d-inline-block"></i><span><small class="d-inline-block date_message" > </small></span><div class="clear"></div> </div></div>' +
//             ' <div class="sender media-right friend-box"><a href="javascript:void(0);" title="Moi"></a> </div>' +
//             '</div>');
