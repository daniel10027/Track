...
$(document).on('click', '#main-chat #sidebar .user-box .userlist-box', function () {
    ...
    var newBox = '<li class="chat-single-box card-shadow bg-white active" data-id="{0}" id={0}><div class="had-container"><div class="chat-header p-10 bg-gray"><div class="user-info d-inline-block f-left"><a href="#">{1}</a></div><div class="box-tools d-inline-block"><a href="#" class="mini"><i class="icofont icofont-minus f-20 m-r-10"></i></a><a class="close" href="#"><i class="icofont icofont-close f-20"></i></a></div></div><div class="chat-body p-10 {0}"><div class="message-scrooler"><div class="messages"></div></div></div><div class="chat-footer b-t-muted"><div class="input-group write-msg"><input type="text" name="message{0}" class="form-control input-value sms{0}" placeholder="Votre message" spellcheck="false" autocomplete="off" onkeydown="send_message(\'{0}\', event)"></div></div></div></li>';
    }
    else{
